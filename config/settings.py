...
PORT = 2000
url = "https://gpt-bot-795742062431.europe-west1.run.app"
DISCORD_TOKEN = os.environ.get("tokenDiscord")
stream = f'{url}/stream'
instructions_url = f'{url}/instructions'
clear = f'{url}/clear'
file_search = f'{url}/file-search'
remove_historique = f'{url}/remove_historique'
images = f"{url}/images"
edit_images = f"{url}/edit_images"
