...
model_gpt_image = "gpt-image-2.5-sunburst"
gpt_image_size = "auto"
...
ADRESSE_SERVEUR_MCP = os.environ.get("ADRESSE_SERVEUR_MCP", "")
SERVER_DESCRIPTION = os.environ.get("SERVER_DESCRIPTION", "")
system_jdr_msg = os.environ.get(
    "SYSTEM_JDR_MSG",
    "Tu es un maitre du jeu. Reste coherent avec l'historique, gere les consequences et arbitre les actions proprement.",
)
...
model = "gpt-6-sol"
model_reasoning = "gpt-6-astra"
model_cyber = "gpt-5.6-cyber"
